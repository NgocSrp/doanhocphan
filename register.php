...
<section id="title-header">
  <div class="title">  
  <h2>Website Học tiếng anh trực tuyến</h2> 
    <p>Nhóm 13  </p>  
  </div>
</section> 
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: #c2c0bd; color:#fff;">
              <p align="left">&copy; Đội ngũ nhóm 13_CNPM - Đại học Vinh</p>
     </footer>
 </section>

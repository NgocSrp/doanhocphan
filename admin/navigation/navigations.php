...
<title>Hỗ trợ học tiếng anh trực tuyến</title>
...
<div class="navbar-header">
  ...
  <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" > Hỗ trợ học tiếng anh trực tuyến </a>
</div>
...
<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <!--     <li>
                ...
                <li>
                     <a href="<?php echo web_root; ?>admin/modules/lesson/index.php"><i class="fa fa-user fa-fw"></i> Bài học </a> 
                </li>
                 <li>
                     <a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="fa fa-user fa-fw"></i> Bài tập </a> 
                </li>
                 <li>
                     <a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="fa fa-user fa-fw"></i> Học sinh </a> 
                </li>

                
                <li><a href="<?php echo web_root; ?>admin/modules/user/index.php"><i class="fa fa-user fa-fw"></i> Quản lý người dùng</a></li>
...
<section id="page-footer"> 
      <footer>  <p align="center">&copy; Hỗ trợ học tiếng anh trực tuyến </p></footer>
</section>
<!-- Plugins -->
